...
open FOUT, ">auto-generate/$product\_$fname_no_ext.c" || die "can't open $ARGV[0].c";
...
print "#include <hsad/config_data.h>\n";
print "#include <hsad/config_general_struct.h>\n";
#print "#include \"hwconfig_enum.h\"\n\n";
print "config_pair  ".$product."_".$fname_no_ext."_common [] = {\n";
...
print "    {0, 0, 0}\n };";
print "\n";
print "struct board_id_general_struct ".$product."_$fname_no_ext= {\n";
print "	.name=COMMON_MODULE_NAME,\n";
print "	.board_id=BOARD_ID_".uc($product).",\n";
print "	.data_array={.config_pair_ptr=".$product."_".$fname_no_ext."_common},\n";

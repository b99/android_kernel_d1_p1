...
static const unsigned short huawei_keypad_wakeup_enable[ARRAY_SIZE(huawei_keypad_col_gpios) *
					  ARRAY_SIZE(huawei_keypad_row_gpios)] = {
    /*< 20131118 g00219993 light up the screen with the volume keys begin */
	[KEYMAP_INDEX(0, 0)] = GPIO_WAKEUP_ENABLED,
	[KEYMAP_INDEX(1, 0)] = GPIO_WAKEUP_ENABLED,
	/*< 20131118 g00219993 light up the screen with the volume keys end */
};
